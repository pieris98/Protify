...
For the full project story, installation options, and high-level usage, see the main [README](https://github.com/gleghorn-lab/Protify/blob/main/README.md) in the repository root.
...
3. **YAML run:** Edit [src/protify/yamls/base.yaml](https://github.com/gleghorn-lab/Protify/blob/main/src/protify/yamls/base.yaml) and run:
