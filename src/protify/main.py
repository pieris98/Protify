...
def parse_arguments():  
    ...
    parser.add_argument("--expansion_ratio", type=float, default=8/3, help="FFN expansion ratio for InterpNet/transformer probes.")
    ...
    parser.add_argument("--push_raw_probe_repo", type=str, default=None, help="Custom HF repo id for --push_raw_probe (e.g. 'Synthyra/realness_oracle_interp'). If omitted, auto-generated.")
